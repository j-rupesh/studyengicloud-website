...
const DownloadNotesSection = () => {
  ...
  const fileItems = [
    { id: 1, name: "Lecture Notes.pdf", type: "pdf", link: "https://drive.google.com/file/d/1m__6bGXjXDJuQ1nXv2aEk72DtQuaWQ5A/view?usp=sharing" },
     { id: 1, name: "Lecture Notes.pdf", type: "pdf", link: "https://drive.google.com/file/d/1OFGYWHKZPJECQC8D0TBQ_GLrkwNOBnBf/view?usp=sharing" },
  ...
  return (
    <div className="bg-gradient-to-r from-white  via-gray-300 animate-gradient bg-cover py-12">
      <div className="text-center mb-10">
        ...
        <h3 className="text-xl text-gray-700">Problem Solving Programming -II</h3>
      </div>
