  ...
  const notesCategories = [
    {
      ...
      downloadLink: 'https://drive.google.com/file/d/1ODcOUGWj12TtSuog1AszWxl4aflxHir8/view?usp=sharing',
      year: ' 🔴 (2023 PATTERN)',
      questions: [
        {
    ...
    },
    {
      ...
      title: 'Unit 3-6',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1-Aj4IjLoIJZVJykZXA86mH5eIKmtDE11/view?usp=sharing',
      year: ' 🔴 (2023 PATTERN)',
      questions: [
      ...
      title: 'Unit 3-6',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1F3mtEOSyhnOGPaCJ6KaLWT-0jaJBxbo6/view?usp=sharing',
      year: ' 🔴 2022-23',
      questions: [
        { question: "Which of the following is used to allocate memory dynamically in C?", options: ["malloc()", "new()", "alloc()", "allocate()"], correctAnswer: "malloc()" },
        { question: "What is the size of an int in C (typically)?", options: ["2 bytes", "4 bytes", "8 bytes", "1 byte"], correctAnswer: "4 bytes" },
      ...
      title: 'Unit 3-6',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1QPtG99mQlwIw-AVePglAxv8svsZmMZ6H/view?usp=sharing',
      year: ' 🔴 (Jan. 2025, 2024/2023/2022 Pattern)',
      questions: [
        { question: "Which of the following is used to allocate memory dynamically in C?", options: ["malloc()", "new()", "alloc()", "allocate()"], correctAnswer: "malloc()" },
        { question: "What is the size of an int in C (typically)?", options: ["2 bytes", "4 bytes", "8 bytes", "1 byte"], correctAnswer: "4 bytes" },
        { question: "What does the acronym 'CPU' stand for?", options: ["Central Processing Unit", "Computer Processing Unit", "Core Processing Unit", "Command Processing Unit"], correctAnswer: "Central Processing Unit" },
