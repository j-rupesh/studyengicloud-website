  ...
  const notesCategories = [
    {
      ...
      downloadLink: 'https://drive.google.com/file/d/1gXdGErCOmBD1bCYe5sSr3ulPrESyTjIs/view?usp=sharing',
      year: ' 🔴 (May 2024)',
      questions: [
        {
    ...
    },
    {
      ...
      title: 'Unit 1',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/107-Jvwk6N5pdtyd7cfskNnP93mez0qxT/view?usp=sharing',
      year: ' 🔴  2022-23',
      questions: [
      ...
      title: 'Unit 1',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1N97luaOD07db8F3hiPBuvwrYt9c57ZV9/view?usp=sharing',
      year: ' 🔴 (Jan. 2025)',
      questions: [
        { question: "Which of the following is used to allocate memory dynamically in C?", options: ["malloc()", "new()", "alloc()", "allocate()"], correctAnswer: "malloc()" },
        { question: "What is the size of an int in C (typically)?", options: ["2 bytes", "4 bytes", "8 bytes", "1 byte"], correctAnswer: "4 bytes" },
  ...
  return (
    <div className="bg-gradient-to-r from-white  via-gray-300 animate-gradient bg-cover py-12">
      <div className="text-center mb-10">
        ...
        <h3 className="text-xl text-gray-700">Basic in Mechanical Engineering</h3>
      </div>
