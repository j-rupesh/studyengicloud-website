  ...
  const notesCategories = [
    {
      ...
      downloadLink: 'https://drive.google.com/file/d/1XygEJ8GAfPP-SNF1g6T7qaCrHY1eCLL1/view?usp=sharing',
      year: ' 🔴 2024(PATTERN)',
      questions: [
        {
    ...
    },
    {
      ...
      title: 'Unit 3-6',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1A7pC7c_aeOGBsNlnRTNjp7tvS_-fZ0_8/view?usp=sharing',
      year: ' 🔴 (May 2024, 2022/2023 Pattern)',
      questions: [
      ...
      title: 'Unit 3-6',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/15QHj7Pjk--TgQVMzEMZtnhe9iAPDMCZi/view?usp=sharing',
      year: ' 🔴 (May 2024, 2022/2023 Pattern)',
      questions: [
        { question: "Which of the following is used to allocate memory dynamically in C?", options: ["malloc()", "new()", "alloc()", "allocate()"], correctAnswer: "malloc()" },
        { question: "What is the size of an int in C (typically)?", options: ["2 bytes", "4 bytes", "8 bytes", "1 byte"], correctAnswer: "4 bytes" },
      ...
      title: 'Unit 3-6',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/17XIstKDgWH2Y0nPIu0OEU53qS8s-txpi/view?usp=sharing',
      year: ' 🔴 (2022 PATTERN)',
      questions: [
        { question: "Which of the following is used to allocate memory dynamically in C?", options: ["malloc()", "new()", "alloc()", "allocate()"], correctAnswer: "malloc()" },
        { question: "What is the size of an int in C (typically)?", options: ["2 bytes", "4 bytes", "8 bytes", "1 byte"], correctAnswer: "4 bytes" },
  ...
  return (
    <div className="bg-gradient-to-r from-white  via-gray-300 animate-gradient bg-cover py-12">
      <div className="text-center mb-10">
        ...
        <h3 className="text-xl text-gray-700">Industrial Chemistry </h3>
      </div>
