  ...
  const notesCategories = [
    {
      ...
      downloadLink: 'https://drive.google.com/file/d/12IgbN8upDFWSYzq674WP6UBt0XvL42G5/view?usp=sharing',
      year: ' 🔴 ( 2024 )',
      questions: [
        {
    ...
    },
    {
      ...
      title: 'Unit 1',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1er2jjBGaKSsQwkKkG60eNGsZdF0Z8jtY/view?usp=sharing',
      year: ' 🔴 ( May 2024 )',
      questions: [
      ...
      title: 'Unit 1',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1zyMHD2JfowZrNbdUvOKLMHd6f1WTZsWH/view?usp=sharing',
      year: ' 🔴 (2023 PATTERN)',
      questions: [
        { question: "Which of the following is used to allocate memory dynamically in C?", options: ["malloc()", "new()", "alloc()", "allocate()"], correctAnswer: "malloc()" },
        { question: "What is the size of an int in C (typically)?", options: ["2 bytes", "4 bytes", "8 bytes", "1 byte"], correctAnswer: "4 bytes" },
  ...
  return (
    <div className="bg-gradient-to-r from-white  via-gray-300 animate-gradient bg-cover py-12">
      <div className="text-center mb-10">
        ...
        <h3 className="text-xl text-gray-700">Basic Electronics Engineering</h3>
      </div>
