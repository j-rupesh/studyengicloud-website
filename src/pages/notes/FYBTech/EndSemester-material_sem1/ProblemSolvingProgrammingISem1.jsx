...
const DownloadNotesSection = () => {
  ...
  const notesCategories = [
    {
      ...
      downloadLink: 'https://drive.google.com/file/d/1G8vEPtGPLYuURkaAEYkf6CoTV6wAwGbE/view?usp=sharing',
      year: ' 🔴 2023-24',
      questions: [
        {
    ...
    },
    {
      ...
      title: 'Unit 1',
      thumbnailSrc: 'https://i.ibb.co/q3YTmXCh/quest-on-paper.png',
      downloadLink: 'https://drive.google.com/file/d/1ZI7DJdFL_3zNVw3h82DpDum9QDGJ4rth/view?usp=sharing',
      year: ' 🔴 2024-  25',
      questions: [
  ...
  const fileItems = [
     { id: 1, name: "Lecture Notes.pdf", type: "pdf", link: "https://drive.google.com/file/d/1G8vEPtGPLYuURkaAEYkf6CoTV6wAwGbE/view?usp=sharing" },
     { id: 1, name: "Lecture Notes.pdf", type: "pdf", link: "https://drive.google.com/file/d/1ZI7DJdFL_3zNVw3h82DpDum9QDGJ4rth/view?usp=sharing" },
  ...
  return (
    <div className="bg-gradient-to-r from-white  via-gray-300 animate-gradient bg-cover py-12">
      <div className="text-center mb-10">
        ...
        <h3 className="text-xl text-gray-700">Problem Solving Programming -I </h3>
      </div>
